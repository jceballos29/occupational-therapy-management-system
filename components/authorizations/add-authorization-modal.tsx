...
export function AddAuthorizationModal({ patientId, insurerId, insurerName, hasActiveAuth }: AddAuthorizationModalProps) {
  ...
  // Si no tiene aseguradora, no mostramos el botón (o lo mostramos deshabilitado)
  if (!insurerId) {
    return (
        <Button size="sm" variant="outline" disabled title="Solo para pacientes asegurados">
    ...
    <Dialog open={open} onOpenChange={setOpen}>
      ...
      <DialogContent className="sm:max-w-[425px]">
        <DialogHeader>
          ...
          <DialogDescription>
            Registra un nuevo paquete de sesiones para <strong>{insurerName}</strong>.
          </DialogDescription>
        </DialogHeader>
            ...
            {hasActiveAuth && (
                <Alert>
                    ...
                    <AlertDescription className="mt-2">
                        El paciente ya tiene un paquete activo. ¿Qué deseas hacer con el anterior?
